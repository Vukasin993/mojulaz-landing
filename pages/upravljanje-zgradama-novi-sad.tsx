...
const content = {
  sr: {
    ...
    faq: [
      ...
      { q: 'Koliko košta MojUlaz?', a: '2.190 RSD po zgradi godišnje. Sve funkcionalnosti su uključene. Prvih 30 dana je besplatno, bez kreditne kartice.' },
  ...
  en: {
    ...
    faq: [
      ...
      { q: 'How much does MojUlaz cost?', a: '2,190 RSD per building per year. All features included. The first 30 days are free, no credit card required.' },
