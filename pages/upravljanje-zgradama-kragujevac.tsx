...
const content = {
  sr: {
    ...
    faq: [
      ...
      { q: 'Koliko košta MojUlaz za kragujevačke upravnike?', a: '2.190 RSD po zgradi godišnje. Sve funkcionalnosti su uključene od prvog dana — prijava kvarova, obaveštenja, finansije, glasanje i dokumentacija. Probni period od 30 dana je potpuno besplatan.' },
  ...
  en: {
    ...
    faq: [
      ...
      { q: 'How much does MojUlaz cost for Kragujevac managers?', a: '2,190 RSD per building per year. All features included from day one — issue reporting, announcements, finances, voting and documentation. The 30-day trial is completely free.' },
