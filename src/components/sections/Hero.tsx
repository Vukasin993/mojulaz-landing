      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 xl:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <a href="#" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '10px 18px', borderRadius: 12, background: '#000', color: '#fff', textDecoration: 'none', boxShadow: '0 2px 10px rgba(0,0,0,0.18)', transition: 'transform 0.2s, box-shadow 0.2s' }}
